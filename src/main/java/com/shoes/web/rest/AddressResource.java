...
/**
 * REST controller for managing {@link com.shoes.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Address> partialUpdateAddress(
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getLastModifiedBy() != null) {
                    existingAddress.setLastModifiedBy(address.getLastModifiedBy());
                }
                if (address.getLastModifiedDate() != null) {
                    existingAddress.setLastModifiedDate(address.getLastModifiedDate());
                }
