...
public class ShoesDetailsResource {
    ...
    public ShoesDetailsResource(ShoesDetailsService shoesDetailsService, ShoesDetailsRepository shoesDetailsRepository) {
        this.shoesDetailsService = shoesDetailsService;
