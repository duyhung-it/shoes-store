...
public class OrderRepositoryCustomImpl implements OrderRepositoryCustom {
    ...
    public Query buildQuery(OrderSearchReqDTO orderSearchReqDTO) {
        ...
        StringBuilder query = new StringBuilder(
            "select o.id,o.code,o.phone , o.last_modified_by as lastModifiedBy , o.created_date as createdDate , o.total_price as totalPrice ,o.owner_id as idCustomer ,concat(ju.first_name , ' ' ,ju.last_name) as customer, o.status  from `shoes-store`.jhi_order o   \n" +
            " join `shoes-store`.jhi_user ju on ju.id = o.owner_id \n" +
            " where o.status <> -1"
        );
